"""
i think this from the monolith sketch - this will move to monologue as part of the optools
we need to factor out a library for "functions" and inspection - which could be Thyme in prototyping
the idea of functions and types is a powerful one. ive merged some of this into monologue which is not quite right
